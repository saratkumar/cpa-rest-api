...
public interface CriticalPathAnalysisOutputDataRepository extends JpaRepository<CriticalPathAnalysisOutputData, Long> {
    ...
    List<CriticalPathAnalysisOutputData> findTop10ByBusinessDateAndTargetAndEntityAndSysParamOrderByDurationDesc(String businessDate, String jobName, String entity, String sysParam);
